...
> **Версия:** 1.4
> **Дата:** 2026-04-28
> **Статус:** Фаза 0 ✅ · Фаза 1 ✅ · Фаза 2 ✅ · Фаза 3 ✅ · Фаза 4 ✅ · Фаза 5 ✅ · Фаза 6 ✅ — `cargo build` 0 ошибок (2026-04-29)
...
**Отложено (Фаза 6.5):**
- [ ] LOD-версии Moon.glb (40 МБ) и Earth.glb (5.9 МБ) — при необходимости
- [ ] Окно выбора момента TLI (T+ дедлайн)
- [ ] Полная отладочная команда перехода на любой стейт
