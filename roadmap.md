...
> **Версия:** 1.4
> **Дата:** 2026-04-28
> **Статус:** Фаза 0 ✅ · Фаза 1 ✅ · Фаза 2 ✅ · Фаза 3 ✅ · Фаза 4 — в процессе (тонкий вертикальный слой Orbit + TLI готов)
...
### Фаза 4 — Орбита и TLI: этапы 2–3 — в процессе
...
**Что ещё нужно для полного DoD Phase 4:**
- [ ] `CameraMode::Cockpit` (вид из Orion) и `CameraMode::Chase`
- [ ] Окно выбора момента TLI (T+ дедлайн, штраф за опоздание)
- [ ] Сделать ошибку Δv детерминированной: использование точности `TliResult::accuracy_pct` для смещения перицентра в Phase 5
- [ ] Доработка HUD во время TLI: дистанция до Земли, расход ICPS
